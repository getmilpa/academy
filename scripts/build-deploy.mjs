 ...
 * deployed site serves the R1 pages at clean roots (/ and /en/) with the
 * shared assets at /artifacts/, so this build:
 *   - copies site/ → _deploy/ (es at /, en at /en/, plus sitemap/robots/llms),
...
// 1. site/ contents become the deploy root (index.html at /, en/ at /en/, SEO files).
...
for (const rel of PAGES) {
  ...
  html = html.replaceAll("../../artifacts/", "/artifacts/").replaceAll("../artifacts/", "/artifacts/");
