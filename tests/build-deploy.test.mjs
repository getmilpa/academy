...
/* Colisión galería + labs (Task 5): los app-dirs artifacts/ y labs/ traen un
   ...
   SSG. Verificamos por CONTENIDO: la galería trae lang="es-MX" + los 11 section
   ids; el shell de labs trae el resumen estático de los 4 labs. */
test("build-deploy: _deploy/artifacts/index.html es la galería SSG (11 artifacts), no el shell legado", () => {
  ...
  for (const id of ["siembra", "pipeline", "compuerta", "atlas", "runtime", "event-log", "design-contract", "plan", "atomo", "frontera", "compuerta-arranque"]) {
...
/* Las páginas de unidad SSG (no colisionan con el app-dir) deben existir en
   ambos idiomas para las 21 unidades del catálogo. */
