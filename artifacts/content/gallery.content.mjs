/* Fuente bilingüe única de la galería de artifacts (artifacts/index.html: los 11
   ...
   5. El artifact #9 (atomo) y el #5 (runtime, graduado P2c) NO reextraen su
      prosa: viven en atomo.content.mjs (ATOMO) y runtime.content.mjs (RUNTIME)
      respectivamente — esas son las fuentes únicas que también emiten
      site/atomo/ y site/runtime/. Acá cada uno solo aporta el data-kind de su
      <section> (que además alimenta el topbar). gen/atomo.mjs y gen/runtime.mjs
      renderizan el fallback estático de cada <milpa-artifact> desde ATOMO/RUNTIME.
...
export const GALLERY = {
  ...
  artifacts: [
    ...
    /* ── Artifact 05: runtime — graduado a artifacts/content/runtime.content.mjs
       (RUNTIME), P2c: mismo criterio que el átomo (Artifact 09). ─────────── */
    {
      id: "runtime",
      /* data-kind de la <section> (además alimenta el topbar). Coincide con la
         prosa que RUNTIME usaba antes de graduar, pero es un nodo DOM distinto
         (el wrapper del shell). Toda la prosa vive en runtime.content.mjs
         (RUNTIME). gen/runtime.mjs renderiza el fallback estático del
         <milpa-artifact> desde RUNTIME, no desde acá. */
